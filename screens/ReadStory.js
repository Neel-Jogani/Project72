...
export default class ReadStoryScreen extends React.Component{
    render(){
      ...
      >
        ...
        />
        <Text style={{textAlign: 'center', fontSize:25, color: 'green'}}>Once, there was a boy who became bored when he watched over the village sheep grazing on the hillside. To entertain himself, he sang out, “Wolf! Wolf! The wolf is chasing the sheep!”
...
An old man went to comfort the boy. As he put his arm around him, he said, “Nobody believes a liar, even when he is telling the truth!”</Text>
      </View>
        )
    }
}